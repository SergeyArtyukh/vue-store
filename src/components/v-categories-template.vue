            ...
            <div class="left-side">
              <div class="img-container" @click="productCardLink">
                ...
                <div :class="sliderElem.classOfNewDevice" class="products-discount-container">
                  <span v-if="sliderElem.oldPrice != null">{{sliderElem.productDiscount + sliderElem.productDiscountSign}}</span>
                </div>
                <span class="card-text">{{sliderElem.text}}</span>
              </div>
              <span v-if="sliderElem.oldPrice != null" class="old-price">{{sliderElem.oldPrice + sliderElem.currencySign}}</span>
